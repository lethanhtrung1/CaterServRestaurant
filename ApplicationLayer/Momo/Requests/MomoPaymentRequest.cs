...
using System.Text;
using ApplicationLayer.Momo.Responses;

namespace ApplicationLayer.Momo.Requests {
	public class MomoPaymentRequest {
		...
		public (bool, string?) GetLink(string paymentUrl) {
			...
			if (createPaymentLinkRes.IsSuccessStatusCode) {
				...
				var responseData = JsonConvert.DeserializeObject<MomoPaymentLinkResponse>(responseContent);
